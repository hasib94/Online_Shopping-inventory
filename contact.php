...
if($_REQUEST['sub'])
 {
 if(mysqli_query($user,"insert into fdbk values('$name','$phone','$email','$subj','$mesg')"))
    {
...
<div>
  <p><br/>
      <font face="Lucida Handwriting" size="+1" color="#996699">E-mail:</font><font face="Lucida Handwriting" size="+1" color="#009966"> jeexan2@gmail.com
      </font><font face="Lucida Handwriting" size="+1" color="#66CC66"><br>
      </font>
	   <br>
    <font color="#996699" size="+1" face="Lucida Handwriting">Address:    <font color="#009966">Jysan Nasid Shop ,Board-Bazar,Dhaka. </font></font></p>
  <p> <font color="#996699" size="+1" face="Lucida Handwriting">Talk to us:</font><font color="#006633" size="+1" face="Lucida Handwriting"> 01749363717/ 5</font><font size="+1"><br>
    <font color="#996699" face="Lucida Handwriting">Fax us at:</font></font> <font color="#006633" size="+1" face="Lucida Handwriting">+02-5468 </font></p>
  <p>&nbsp;</p>
</div>
...
<div>
<div style="width:25%;float:left"><br><br><center><fieldset style="width:25%;background-color:#CC99CC"><p><font size="+1" face="Comic Sans MS">We at Jysan Nasid Shop value your views and your concerns regarding our products and services. We would like to know how we can serve you better. If you have any queries please feel free to drop in your queries at customercarecell@jysanaziz.in and we will be happy to assist you.</font></p>
</fieldset>
</center></div>&nbsp;&nbsp;
